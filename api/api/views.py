...
def graph(request):
    ...
    # Linhas
    fig.add_trace(go.Scatter(x=duration_anos, y=corporate_di, mode='lines', name='Corporate DI'))
    fig.add_trace(go.Scatter(x=duration_anos, y=engie_brasil, mode='lines', name='Engie Brasil'))
    ...
    # Layout
    fig.update_layout(
        title='Comparação de Corporate DI e Engie Brasil com Pontos e Boxplots',
